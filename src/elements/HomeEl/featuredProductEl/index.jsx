    ...
    return (
        <div className="container mx-auto w-full flex flex-col gap-3 mt-7 p-2 relative">
            <div className="w-full flex items-center justify-start">
                <p className="font-bold text-3xl">Featured Product</p>
            </div>
            <Separator />
            <div
                ref={scrollContainerRef}
                className="overflow-x-auto scrollbar-hide overflow-y-hidden h-fit grid grid-flow-col auto-cols-max gap-2 w-full"
            >
